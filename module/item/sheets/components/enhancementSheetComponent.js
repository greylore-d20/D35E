...
export class EnhancementSheetComponent extends ItemSheetComponent {
    ...
    prepareSheetData(sheetData) {
        if (this.sheet.item.type === "equipment" || this.sheet.item.type === "weapon") {
            ...
            _enhancements.forEach(e => {
                ...
                e.incorrect = !((e.data.enhancementType === 'weapon' && this.sheet.item.type === 'weapon') || (e.data.enhancementType === 'armor' && this.sheet.item.type === 'equipment') || (e.data.enhancementType === 'misc'));
    ...
    activateListeners(html) {
        ...
        html.find("div[data-tab='enhancements'] .item-detail.item-uses input.maxuses").off("change").change(this.#setEnhMaxUses.bind(this));
        html.find("div[data-tab='enhancements'] .item-detail.item-per-use input[type='text']:not(:disabled)").off("change").change(this.#setEnhPerUse.bind(this));
        html.find("div[data-tab='enhancements'] .item-detail.item-enh input[type='text']:not(:disabled)").off("change").change(this.#setEnhValue.bind(this));
        html.find("div[data-tab='enhancements'] .item-detail.item-cl input[type='text']:not(:disabled)").off("change").change(this.#setEnhCLValue.bind(this));
