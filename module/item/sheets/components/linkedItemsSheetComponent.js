...
export class LinkedItemsSheetComponent extends ItemSheetComponent{
    ...
    registerTab(sheetData) {
        sheetData.registeredTabs.push({id:'links',name:"Links",sheet:'systems/D35E/templates/items/parts/item-links.html'})
    }

    activateListeners(html) {
        html.find('div[data-tab="linked-items"]').on("drop", this.#onDrop.bind(this,"link"));
        html.find('div[data-tab="linked-items"] .item-delete').click(this.#onLinkedItemDelete.bind(this));
    }
